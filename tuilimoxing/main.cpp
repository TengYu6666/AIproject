...
int main() {
    ...
    // 路径设置
    string model_path = "E:/opencv推理/tuilimoxing/resnet18_imagenet (1).onnx";
    string image_path = "E:/opencv推理/tuilimoxing/banana1.jpg";
    string csv_path = "E:/opencv推理/tuilimoxing/imagenet_class_index.csv";
